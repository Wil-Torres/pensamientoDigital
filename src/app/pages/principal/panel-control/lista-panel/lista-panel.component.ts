...
@Component({
  ...
  template: `
    <div class="card-deck">
      <div class="col-md-3">
          <div class="card mb-3">
              <img src="../../../../../assets/images/temporal/chart.png" class="card-img-top" alt="...">
              <div class="card-body">
      ...
      <div class="col-md-3">
          <div class="card mb-3">
              <img src="../../../../../assets/images/temporal/chart.png" class="card-img-top" alt="...">
              <div class="card-body">
                  <h5 class="card-title">GRAFICA # 5</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                  <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
          </div>
      ...
      <div class="col-md-3">
          <div class="card mb-3">
              <img src="../../../../../assets/images/temporal/chart.png" class="card-img-top" alt="...">
              <div class="card-body">
                  <h5 class="card-title">GRAFICA # 6</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                  <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
          </div>
      ...
      <div class="col-md-3">
          <div class="card mb-3">
              <img src="../../../../../assets/images/temporal/chart.png" class="card-img-top" alt="...">
              <div class="card-body">
                  <h5 class="card-title">GRAFICA # 7</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                  <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
          </div>
      ...
      <div class="col-md-3">
          <div class="card mb-3">
              <img src="../../../../../assets/images/temporal/chart.png" class="card-img-top" alt="...">
              <div class="card-body">
                  <h5 class="card-title">GRAFICA # 8</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                  <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
          </div>
